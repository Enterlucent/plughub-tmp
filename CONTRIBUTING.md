...
2. Create a "Bug Report" on the [Issues Tracker](https://github.com/enterlucent/plughub/issues/new?template=bug_report.md).
...
1. **Check for Existing Requests:**  
   Search [open feature requests](https://github.com/enterlucent/plughub/issues?q=label%3Aenhancement+is%3Aopen+-label%3Adocumentation) to see if your idea has already been suggested.
    - If a similar request exists, expand on it by commenting rather than opening a duplicate.
2. **Create a New Feature Request:**  
   Open a [Feature Request](https://github.com/enterlucent/plughub/issues/new?template=feature_request.md) on the Issues Tracker.
...
1. **Check for Existing Documentation Requests:**  
   Review [open documentation requests](https://github.com/enterlucent/plughub/issues?q=label%3Aenhancement,documentation+is%3Aopen) to see if your suggestion has already been made.
...
2. **Create a New Documentation Request:**  
   Open an [Issue](https://github.com/enterlucent/plughub/issues/new?template=documentation_request.md) explaining your proposed documentation changes or additions.
...
1. **Check the Issue Tracker:**  
   Look for [Documentation Requests](https://github.com/enterlucent/plughub/issues?q=label%3Aenhancement,documentation,approved+is%3Aopen+no%3Aassignee) that are open, “approved,” and unassigned.  
   _Only begin work on issues that meet these criteria._
2. **Review Existing Documentation:**  
   There may be bugs or outdated sections in the current docs:
   - [Project Documentation](https://github.com/enterlucent/plughub/Documentation/)
...
1. **Browse the [Issue Tracker](https://github.com/enterlucent/plughub/issues?q=label%3Aenhancement,bug,approved+is%3Aopen+no%3Aassignee+-label%3Adocumentation):**
